...
function Inner() {
  ...
  return (
    <div className="fixed bg-red-50 z-50 p-2 text-center border border-gray-400 drop-shadow-xl shadow-black text-2xl rounded left-2 top-2 hover:bg-gray-400 hover:text-white cursor-pointer">
